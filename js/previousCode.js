...
function removeAllChildren(articleSection) {
 ...
 window.addEventListener("DOMContentLoaded", async function(){
  try {
    ...
    const response = await fetch('https://newsapi.org/v2/top-headlines?country=us&language=en&apiKey=1006e9f332db40bd8553b27720785488')
 ...
 techButton.addEventListener("click", async function () {
  try {
    console.log("techButton is responsive")
    articleSection.replaceChildren();
    const response = await fetch('https://newsapi.org/v2/everything?q=tech&language=en&from=2024-11-05&sortBy=publishedAt&apiKey=1006e9f332db40bd8553b27720785488')
...
appleButton.addEventListener("click", async function() {
 ...
 teslaButton.addEventListener("click", async function() {
  try {
    console.log("teslaButton is responsive")
    articleSection.replaceChildren();
    const response = await fetch('https://newsapi.org/v2/everything?q=tesla&language=en&from=2024-11-5&sortBy=publishedAt&apiKey=1006e9f332db40bd8553b27720785488')
 ...
 economyButton.addEventListener("click", async function() {
  try {
    ...
    articleSection.replaceChildren();
    const response = await fetch('https://newsapi.org/v2/top-headlines?language=en&category=business&apiKey=1006e9f332db40bd8553b27720785488')
